window.addEventListener('load', () => {
  ...
  // блок 6
  function transformTitle6(selector, $scroller) {
    document.querySelectorAll(selector).forEach(block => {
      let tl = gsap
        .timeline({
          paused: true,
  ...
  transformTitle6('.section-6__title__wrapper .title');
  ...
  function transformAnimationBg1Section6(selector, $scroller) {
    document.querySelectorAll(selector).forEach(block => {
      let tl = gsap
        .timeline({
          paused: true,
        ...
        .fromTo(
          block,
          { scale: 1},
          { scale: 1.1, duration: 1, ease: "power4.out" }
        );
    });
  }
  transformAnimationBg1Section6('.section-6__title__wrapper .decor');

  function transformAnimationBg2Section6(selector, $scroller) {
    document.querySelectorAll(selector).forEach(block => {
      let tl = gsap
        .timeline({
          paused: true,
  ...
  transformAnimationBg2Section6('.section-6__bottom .decor');
